...
namespace YoutubeExtractor
{
    ...
    public class AudioDownloader : Downloader
    {
        ...
        public AudioDownloader(VideoInfo video, string musicPath, string videoPath, int? bytesToDownload = null)
            : base(video, musicPath, bytesToDownload)
        {
        ...
        {
            //Lets keep that video around
            //string tempPath = Path.GetTempFileName();

            this.DownloadVideo(videoPath);
